                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-group clearfix">
                                                                <div class="icheck-success d-inline">
                                                                    <input type="radio" name="gender" value="M" id="radioPrimary1"  value="{{$user->gender}}">
                                                                    <label for="radioPrimary1">Male</label>
                                                                </div>
                                                                &ensp;&ensp;
                                                                <div class="icheck-info d-inline">
                                                                    <input type="radio" name="gender" value="F" id="radioPrimary2" value="{{$user->gender}}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-success d-inline">
                                                <input type="radio" name="gender" value="M" id="radioPrimary1" checked="">
                                                <label for="radioPrimary1">Male</label>
                                            </div>
                                            &ensp;&ensp;
                                            <div class="icheck-info d-inline">
