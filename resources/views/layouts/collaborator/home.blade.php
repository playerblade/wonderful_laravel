  ...
  <nav class="main-header navbar navbar-expand-md navbar-light navbar-white elevation-1">
    <div class="container">
      ...
      <div class="collapse navbar-collapse order-3" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a href="/reportes/cliente/5/ordenes" class="nav-link">Ver Ordenes En Proceso</a>
          </li>
          <li class="nav-item">
            <a href="/reportes/cliente/5/ordenes" class="nav-link">Cambiar Estado de Ordenes en Proceso</a>
          </li>
