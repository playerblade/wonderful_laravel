                    ...
                    $.get('get_articles_for_categories',{category_id: category_id}, function (articles) {
                        ...
                        $.each(articles, function (index , value ){
                            $('#content').append("<div class='row'>\n" +
                                ...
                                "                                    <a href='/order/"+index+"/form' class='btn bg-gradient-primary btn-sm mt-2'>Ver detalle del producto</a>\n" +
                                "                                </div>\n" +
                                "                                <div  class='col-8'>\n" +
                                "                                    <h3>"+value[0]+"</h3>\n" +
                                "                                    <br>\n" +
                                ...
                                "                                        </div>\n" +
                                "                                        <br><br><br>\n" +
                                "                                        <a href='/order/"+index+"/form' class='btn bg-gradient-primary btn-sm float-right'>Añadir al carrito</a>\n" +
                                "                                    </div>\n" +
                                "                                </div>\n" +
                                "                            </div>\n" +
                                "                            <hr>\n" +
                    ...
                    $.get('get_search_articles',{text: text}, function (articles) {
                        ...
                        $.each(articles, function (title , value){
                            $('#content').append("<div class='row'>\n" +
                                ...
                                "                                    <a href='/order/"+value[0]+"/form' class='btn bg-gradient-primary btn-sm mt-2'>Ver detalle del producto</a>\n" +
                                "                                </div>\n" +
                                "                                <div  class='col-8'>\n" +
                                "                                    <h3>"+title+"</h3>\n" +
                                "                                    <br>\n" +
                                ...
                                "                                        </div>\n" +
                                "                                        <br><br><br>\n" +
                                "                                        <a href='/order/"+value[0]+"/form' class='btn bg-gradient-primary btn-sm float-right'>Añadir al carrito</a>\n" +
                                "                                    </div>\n" +
                                "                                </div>\n" +
                                "                            </div>\n" +
                                "                            <hr>\n" +
